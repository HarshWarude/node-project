...
const jwtService = require('../../../services/jwt/indexJwt');
const responseHelper = require('../../../services/customResponse/customIndex');
...
module.exports = {
    ...
    login: async (req, res) => {
        ...
        try {
            let emails = [
                'admin@mishmash.com',
                'admin@mishmash.support.com',
                'admin@mishmash.help.com'
            ];
            let query = {
                email: reqObj.email
            };
